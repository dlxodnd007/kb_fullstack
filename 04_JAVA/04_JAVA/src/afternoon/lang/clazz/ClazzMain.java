...
public class ClazzMain {
    public static void main(String[] args) throws Exception {
        ...
        Class clazz2 = new User("태웅").getClass(); // 2. 인스턴스를 만들어서 조회
        ...
        // 상위 클래스 정보 출력
        System.out.println("상위 클래스 = " + clazz1.getSuperclass()); // extends Object 생략
        ...
        //User user = (User) clazz1.getDeclaredConstructors().newInstance();
